...
Options via ROS params: port (default 8080) and camera_topic.
"""
    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def _stream_camera(self):
            if not cam.available():
                return self._send_html("<pre>no forwarded camera stream</pre>", 503)

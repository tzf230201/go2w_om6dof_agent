...
# The AGX may use Wi-Fi when no Go2W Ethernet cable is attached. Let DDS select
# the active interface instead of keeping Unitree's eno1-only CycloneDDS file.
